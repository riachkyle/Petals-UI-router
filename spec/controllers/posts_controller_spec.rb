...
RSpec.describe PostsController, :type => :controller do
    ...
    pic: Rack::Test::UploadedFile.new(Rails.root.join('spec/fixtures/images/oahu_map.png'), 'image/png'),
  ...
  describe "serializer" do
    before do
      @json = PostSerializer.new({caption: 'asdf'})
    end
    it "should give out the correct json format" do
      expect(@json.root).to be(nil)
      expect(@json.object.to_json).to eq("{\"caption\":\"asdf\"}")
    end
  end
